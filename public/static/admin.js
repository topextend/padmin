...
// |----------------------------------------------------------------------
// |Description  : Js Of Admin
// |----------------------------------------------------------------------
// |FilePath     : \padmin\public\static\admin.js
// |----------------------------------------------------------------------
...
require.config({
    ...
    paths: {
        ...
        'upload': ['../index.php/api/upload?.js'],
...
$(function () {
    ...
    $body.on('click', '[data-icon]', function () {
        var location = 'api/plugs/icon', field = this.dataset.icon || this.dataset.field || 'icon';
    ...
    $.loadQueue = function (code, doScript, doAjax) {
        ...
        (function loadprocess(code, that) {
            ...
            $.form.load('api/queue/progress', {code: code}, 'post', function (ret) {
                if (ret.code) {
                    that.lines = [];
